    ...
    return (
      <div className="p-8">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-yellow-800 mb-2">No Configuration Found</h3>
          <p className="text-yellow-700 mb-4">
            Unable to load P&L configuration. This might be due to:
          </p>
          <ul className="list-disc list-inside text-yellow-700 mb-4 space-y-1">
            <li>Missing Vercel Blob storage access</li>
            <li>Invalid BLOB_READ_WRITE_TOKEN environment variable</li>
